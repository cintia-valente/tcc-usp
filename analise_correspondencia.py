...
print("\nGerando gráfico para 'SegurançaPsicologica' x 'BemEstarEmocional'")
analise_correspondencia(df_questionario, 'SegurançaPsicologica', 'BemEstarEmocional', 'Segurança psicológica x Bem-estar emocional')
